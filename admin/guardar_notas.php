...
if(isset($_POST['cod_per'], $_POST['cod_mat'], $_POST['cod_prof'], $_POST['nota'], $_POST['porcentaje']) && is_array($_POST['nota']) && !empty($_POST['porcentaje'])){
	...
	foreach($_POST['nota'] as $codigo => $nota){
		$sql="UPDATE notas SET nota='".$nota."', porc_mat=".$_POST['porcentaje']." WHERE cod_estu=".$codigo." AND cod_prof=".$_POST['cod_prof']." AND cod_mat='".$_POST['cod_mat']."' AND cod_per='".$_POST['cod_per']."' AND ISNULL(nota)";
